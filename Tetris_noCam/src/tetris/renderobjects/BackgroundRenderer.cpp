...
void BackgroundRenderer::drawWinBackground()
{
	...
	int dAvatar = dt - components->params()->settings["background"]["fadeStripes"].get<int>() - components->params()->settings["background"]["break"].get<int>() - components->params()->settings["background"]["fadePilot"].get<int>();
	if (dAvatar > 0) {
